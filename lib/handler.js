...
async function fetchGoogleEmail(accessToken) {
    ...
    try {
        ...
        console.error('Google userinfo error:', error.message);
        return null;
    }
}
...
async function handleApiRequest(req, res) {
    ...
    if (pathname === '/api/auth/youtube/token') {
        ...
        const sendToken = (data, setCookie) => {
            ...
            const body = { access_token: data.accessToken };
        ...
        try {
            ...
            if (!updated.email) {
                updated.email = (await fetchGoogleEmail(updated.accessToken)) || undefined;
            }
